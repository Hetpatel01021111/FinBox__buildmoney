      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-8 border-blue-100 focus:border-blue-300 h-10 bg-white shadow-sm"
          />
        </div>
        <div className="flex gap-2">
          ...
          >
            <SelectTrigger className="w-[130px] border-blue-100 bg-white shadow-sm h-10">
          ...
          {(searchTerm || typeFilter || recurringFilter) && (
            <Button
              ...
              title="Clear filters"
              className="border-blue-100 hover:bg-blue-50 h-10 w-10"
            >
              <X className="h-4 w-5" />
            </Button>
          )}
              ...
              paginatedTransactions.map((transaction) => (
                <TableRow key={transaction.id} className="hover:bg-blue-50/50">
                  ...
                  <TableCell className="capitalize">
                    <span
                      style={{
                        background: getCategoryStyle(transaction.category).color,
                      }}
                      className="px-2 py-1 rounded text-white text-sm"
                    >
                      {getCategoryStyle(transaction.category).icon} {transaction.category}
                    </span>
                  </TableCell>
                  <TableCell
                    className={cn(
                  ...
                  <TableCell>
                    {transaction.isRecurring ? (
                      ...
                      <Badge
                        variant="outline"
                        className="gap-1 text-gray-500 bg-gray-50"
                      >
